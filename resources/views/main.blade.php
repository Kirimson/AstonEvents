...
@section('content')
    ...
    <div class="col-lg-12" id="information-container">
        ...
        <p class="information">It is made to be a one-stop-shop for
            ...
            date. Each event falls into one of three categories, Sport, Culture and Other. Look around and see if there
            is anything that interests you!</p>
        <h3>Interacting With Events</h3>
        <p class="information">On each event page, you can contact the organiser, or show your interest in the event by clicking the
            like button. The 5 most liked events will be shown on the Front Page.</p>
        <h3>Finding Events</h3>
        <p class="information">Use the search feature to find new events, search by name, venue, and organiser. Events can then be sorted
            by their name, amount of likes and time of the event.</p>
        @if(!Auth::check())
            <h3>Registering as an Organiser</h3>
            <p class="information">Want to contribute to Aston Events and become an Organiser? Great! As an organiser, you can create
                multiple
